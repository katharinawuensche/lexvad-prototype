...
const App = () => {
  ...
  const { PHENOMENA, VARIANTS } = window.LEXVAD;
      ...
      <div style={{ paddingTop:65 }}>
        ...
        {page === 'kartierung' && (
          <div style={{ maxWidth:1280, margin:'0 auto', padding:'24px 24px 40px' }}>
            ...
            <div style={{ position:'relative', marginRight: sidebarOpen ? 355 : 0, transition:'margin-right 0.3s ease' }}>
              {(view === 'punktkarte' || view === 'flaechenkarte') && (
                <MapPanel phenomenon={phenomenon} selectedVariant={variantSel} mapMode={mapMode} onPointClick={() => setSidebarOpen(true)} sidebarOpen={sidebarOpen}/>
              )}
              {view === 'vergleichen' && (
            ...
            {sidebarOpen && <Sidebar phenomenon={phenomenon} onClose={() => setSidebarOpen(false)}/>}
          </div>
        )}
